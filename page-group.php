...
<div class="entry-content cf" itemprop="articleBody">
				        ...
				        <div class="ifa-map">
			<a id="rutherford-wilkinson" onclick="selectThis('rutherford-wilkinson')" href="javascript:void(0);" class="bullet preview">Rutherford Wilkinson<img src="http://www.pfgl.co.uk/corporate-solutions/files/2016/02/RWltd_chartered-300x148.jpg" width="100" height="52" class="map-icon" id="map-logo-rutherford"></a>
