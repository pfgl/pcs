...
<div class="entry-content cf" itemprop="articleBody">
				        ...
				        <div class="ifa-map">
                            <div id="rutherford-wilkinson">
                            			                 <a onclick="selectThis('rutherford-wilkinson')" href="javascript:void(0);" class="bullet preview">Rutherford Wilkinson></a>
                            <img src="http://www.pfgl.co.uk/corporate-solutions/files/2016/02/RWltd_chartered-300x148.jpg" class="map-icon" id="map-logo-rutherford">
